    ...
    if (oeuvr != NULL && oeuvr_Ext!=NULL )
   {
       rewind(oeuvr);rewind(oeuvr_Ext);
        ...
        while((fread(&mon_Oeuvr,sizeof(mon_Oeuvr),1,oeuvr_Ext)==1) )
        {
            if (mon_Oeuvr.Artist_Id==Identifiant)
            {
                 printf("\n PM%015d | %50s | %50s | %50s | %015d |   %02i / %02i / %04i   | %50s | %50s | %20f | %20s |",mon_Oeuvr.Id_oeuvr,mon_Oeuvr.Titre,mon_Oeuvr.Desc,mon_Oeuvr.Type,mon_Oeuvr.Artist_Id,mon_Oeuvr.Dat_crea,mon_Oeuvr.Localisa,mon_Oeuvr.Propriet,mon_Oeuvr.Valeur,mon_Oeuvr.Dat_eval);
            printf("\n____________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________");
